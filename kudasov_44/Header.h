...
/**
 * \brief Считать данные с входного файла в строку
 *
...
/**
 * \brief Заполнить одномерный массив одним значением
 *
...
/**
 * \brief Считать данные с .csv файла в строку
 *
